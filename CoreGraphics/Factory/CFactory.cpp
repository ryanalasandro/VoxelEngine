...
#include "../Graphics/CDX12MeshRenderer.h"
...
Graphics::CMeshRenderer* CFactory::CreateMeshRenderer(const CVObject* pObject)
{
#ifdef GRAPHICS_DX12
	return new Graphics::CDX12MeshRenderer(pObject);
#endif
#ifdef GRAPHICS_VULKAN
