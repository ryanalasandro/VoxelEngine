...
namespace Logic
{
	...
	void CTransform::Update()
	{
		...
		m_right = m_worldMatrix.TransformNormal(Math::SIMD_VEC_RIGHT);
		m_up = m_worldMatrix.TransformNormal(Math::SIMD_VEC_UP);
		m_forward = m_worldMatrix.TransformNormal(Math::SIMD_VEC_FORWARD);
