...
namespace Physics
{
	...
	private:
		...
		static int FastSimplex(const Math::SIMDMatrix& simplexIn, Math::SIMDMatrix& simplexOut, Math::SIMDVector& pointOut);
		static int FastSimplexLine(u32 a, u32 b, const Math::SIMDMatrix& simplexIn, Math::SIMDMatrix& simplexOut, Math::SIMDVector& pointOut);
		static int FastSimplexTriangle(u32 a, u32 b, u32 c, const Math::SIMDMatrix& simplexIn, Math::SIMDMatrix& simplexOut, Math::SIMDVector& pointOut);
		static int FastSimplexTetrahedron(u32 a, u32 b, u32 c, u32 d, const Math::SIMDMatrix& simplexIn, Math::SIMDMatrix& simplexOut, Math::SIMDVector& pointOut);
